...
import (
	...
	"github.com/gman0/dummy-autofuse-csi/internal/dummy/driver"
...
func main() {
	...
	if *version {
		fmt.Println("dummy-autofuse-csi plugin version", dummyversion.FullVersion())
		os.Exit(0)
	}

	// Initialize and run the driver.

	log.Infof("dummy-autofuse-csi plugin version %s", dummyversion.FullVersion())
