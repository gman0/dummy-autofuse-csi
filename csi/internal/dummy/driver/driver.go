...
import (
	...
	"github.com/gman0/dummy-autofuse-csi/internal/dummy/automount"
	"github.com/gman0/dummy-autofuse-csi/internal/dummy/controller"
	"github.com/gman0/dummy-autofuse-csi/internal/dummy/identity"
	"github.com/gman0/dummy-autofuse-csi/internal/dummy/node"
	"github.com/gman0/dummy-autofuse-csi/internal/grpcutils"
...
type (
	...
	Opts struct {
		...
		// dummy-autofuse-csi node plugin pod is running.
		NodeID string
	...
	// Driver holds dummy-autofuse-csi driver runtime state.
	Driver struct {
		*Opts
	}
)
...
const (
	// dummy-autofuse-csi driver name.
	DefaultName = "dummy-autofuse-csi"
...
func setupNodeServiceRole(s *grpc.Server, d *Driver) error {
	// First wait until autofs in /dummy is ready.

	err := tryWithTimeout(
		"autofs in /dummy",
		d.Opts.AutomountDaemonStartupTimeoutSeconds,
		func() (bool, error) { return automount.IsAutofs("/dummy") },
	)
	if err != nil {
		return err
	}
